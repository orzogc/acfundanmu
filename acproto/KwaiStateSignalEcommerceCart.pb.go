...
var file_KwaiStateSignalEcommerceCart_proto_goTypes = []interface{}{
...
func file_KwaiStateSignalEcommerceCart_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_KwaiStateSignalEcommerceCart_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
