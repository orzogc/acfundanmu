...
var file_CommonStateSignalPKSoundConfigChanged_proto_rawDesc = []byte{
	...
	0x64, 0x10, 0x01, 0x12, 0x05, 0x0a, 0x01, 0x65, 0x10, 0x02, 0x42, 0x0b, 0x5a, 0x09, 0x2e, 0x3b,
...
var file_CommonStateSignalPKSoundConfigChanged_proto_goTypes = []interface{}{
...
func file_CommonStateSignalPKSoundConfigChanged_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_CommonStateSignalPKSoundConfigChanged_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
