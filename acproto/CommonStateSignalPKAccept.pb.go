...
var file_CommonStateSignalPKAccept_proto_rawDesc = []byte{
	...
	0x01, 0x28, 0x09, 0x52, 0x01, 0x62, 0x42, 0x26, 0x5a, 0x24, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62,
...
var file_CommonStateSignalPKAccept_proto_goTypes = []any{
...
func file_CommonStateSignalPKAccept_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_CommonStateSignalPKAccept_proto_msgTypes[0].Exporter = func(v any, i int) any {
