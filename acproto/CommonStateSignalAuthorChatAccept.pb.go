...
func (x *CommonStateSignalAuthorChatAccept) GetA() string {
	if x != nil {
		return x.A
	}
	return ""
...
func (x *CommonStateSignalAuthorChatAccept) GetB() string {
	if x != nil {
		return x.B
	}
	return ""
...
var file_CommonStateSignalAuthorChatAccept_proto_rawDesc = []byte{
	...
	0x44, 0x61, 0x6e, 0x6d, 0x75, 0x22, 0x3f, 0x0a, 0x21, 0x43, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x53,
	0x74, 0x61, 0x74, 0x65, 0x53, 0x69, 0x67, 0x6e, 0x61, 0x6c, 0x41, 0x75, 0x74, 0x68, 0x6f, 0x72,
	0x43, 0x68, 0x61, 0x74, 0x41, 0x63, 0x63, 0x65, 0x70, 0x74, 0x12, 0x0c, 0x0a, 0x01, 0x61, 0x18,
...
var file_CommonStateSignalAuthorChatAccept_proto_goTypes = []interface{}{
...
func file_CommonStateSignalAuthorChatAccept_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_CommonStateSignalAuthorChatAccept_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
