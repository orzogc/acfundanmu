...
var file_PkPlayerInfo_proto_rawDesc = []byte{
	...
	0x0a, 0x01, 0x63, 0x18, 0x03, 0x20, 0x01, 0x28, 0x08, 0x52, 0x01, 0x63, 0x42, 0x26, 0x5a, 0x24,
...
var file_PkPlayerInfo_proto_goTypes = []any{
...
func file_PkPlayerInfo_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_PkPlayerInfo_proto_msgTypes[0].Exporter = func(v any, i int) any {
