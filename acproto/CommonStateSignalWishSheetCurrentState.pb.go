...
func (x *CommonStateSignalWishSheetCurrentState_WishCurrentState) GetA() string {
	if x != nil {
		return x.A
	}
	return ""
...
func (x *CommonStateSignalWishSheetCurrentState_WishCurrentState) GetB() int64 {
	if x != nil {
		return x.B
	}
	return 0
...
func (x *CommonStateSignalWishSheetCurrentState_WishCurrentState) GetC() int64 {
	if x != nil {
		return x.C
	}
	return 0
...
func (x *CommonStateSignalWishSheetCurrentState_WishCurrentState) GetE() string {
	if x != nil {
		return x.E
	}
	return ""
...
func (x *CommonStateSignalWishSheetCurrentState_WishCurrentState) GetF() string {
	if x != nil {
		return x.F
	}
	return ""
...
var file_CommonStateSignalWishSheetCurrentState_proto_rawDesc = []byte{
	...
	0x72, 0x72, 0x65, 0x6e, 0x74, 0x53, 0x74, 0x61, 0x74, 0x65, 0x12, 0x0c, 0x0a, 0x01, 0x61, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x01, 0x61, 0x12, 0x0c, 0x0a, 0x01, 0x62, 0x18, 0x02, 0x20,
	0x01, 0x28, 0x03, 0x52, 0x01, 0x62, 0x12, 0x0c, 0x0a, 0x01, 0x63, 0x18, 0x03, 0x20, 0x01, 0x28,
	0x03, 0x52, 0x01, 0x63, 0x12, 0x0c, 0x0a, 0x01, 0x64, 0x18, 0x04, 0x20, 0x01, 0x28, 0x03, 0x52,
	0x01, 0x64, 0x12, 0x0c, 0x0a, 0x01, 0x65, 0x18, 0x05, 0x20, 0x01, 0x28, 0x09, 0x52, 0x01, 0x65,
	0x12, 0x0c, 0x0a, 0x01, 0x66, 0x18, 0x06, 0x20, 0x01, 0x28, 0x09, 0x52, 0x01, 0x66, 0x42, 0x26,
...
var file_CommonStateSignalWishSheetCurrentState_proto_goTypes = []any{
...
func file_CommonStateSignalWishSheetCurrentState_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_CommonStateSignalWishSheetCurrentState_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_CommonStateSignalWishSheetCurrentState_proto_msgTypes[1].Exporter = func(v any, i int) any {
