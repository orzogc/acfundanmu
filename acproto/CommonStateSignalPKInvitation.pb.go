...
var file_CommonStateSignalPKInvitation_proto_rawDesc = []byte{
	...
	0x63, 0x18, 0x03, 0x20, 0x01, 0x28, 0x03, 0x52, 0x01, 0x63, 0x42, 0x0b, 0x5a, 0x09, 0x2e, 0x3b,
...
var file_CommonStateSignalPKInvitation_proto_goTypes = []interface{}{
...
func file_CommonStateSignalPKInvitation_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_CommonStateSignalPKInvitation_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
