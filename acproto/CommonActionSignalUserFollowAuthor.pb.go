...
var file_CommonActionSignalUserFollowAuthor_proto_rawDesc = []byte{
	...
	0x73, 0x65, 0x6e, 0x64, 0x54, 0x69, 0x6d, 0x65, 0x4d, 0x73, 0x42, 0x0b, 0x5a, 0x09, 0x2e, 0x3b,
...
var file_CommonActionSignalUserFollowAuthor_proto_goTypes = []interface{}{
...
func file_CommonActionSignalUserFollowAuthor_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_CommonActionSignalUserFollowAuthor_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
