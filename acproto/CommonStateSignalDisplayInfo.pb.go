...
var file_CommonStateSignalDisplayInfo_proto_rawDesc = []byte{
	...
	0x6c, 0x74, 0x61, 0x42, 0x0b, 0x5a, 0x09, 0x2e, 0x3b, 0x61, 0x63, 0x70, 0x72, 0x6f, 0x74, 0x6f,
...
var file_CommonStateSignalDisplayInfo_proto_goTypes = []interface{}{
...
func file_CommonStateSignalDisplayInfo_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_CommonStateSignalDisplayInfo_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
